  ...
  return (
    ...
    <div style={{width:'100%', textDecoration:'none'}}>
      ...
      {isLoading ? (
          ...
          (
            verify ?
            <div style={{marginLeft:'4%'}}>{done && <p>We send reset link on your Email<br></br>Reset your password through the link<br></br>The link will be expired in 5 minutes.</p>}</div>
            : <div style={{marginLeft:'4%'}}>{done && <p>User not exist on TextUp!<br></br>Please Sign Up before reset password</p>}</div>
        ) }
